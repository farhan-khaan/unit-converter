...
# by using google unit converter bu using python and streamlit
...
st.markdown(f"<div class=\"footer\">Developed by <a href=\"https://github.com/yourusername\">Farhan Khan</a></div>", unsafe_allow_html=True)